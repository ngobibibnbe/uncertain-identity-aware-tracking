...
def process_forwad_backward(track_with_observation,nbr_visit="", json_save_path=" Bytetrack/videos/"+video_prev_name+"_with_atq_tracking_with_HMM_resut.json"):
    ...
    Returns:
        write a video with ATQ and put the results in the file  Bytetrack/videos/"+video_prev_name+"_with_atq_tracking_with_HMM_resut.json
    """
    import numpy as np 
    def softmax(x):
        #return x/sum(x)
